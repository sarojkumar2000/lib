...
<div class="collapse navbar-collapse">
			...
			<h1><li class="nav-item"><a href="requestTicketList?id=${id}" class="btn btn-outline-success	">Back</a></li></h1>	&nbsp;		
    ...
    <c:forEach var="books_taken" items="${booksbystudent}">
        <tr>
           
            <td>${books_taken.book_id}</td>
            <td>${books_taken.title}</td>
            <td>${books_taken.author}</td>
